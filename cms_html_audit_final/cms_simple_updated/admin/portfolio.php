...
$documentTypes = ['pdf', 'docx', 'jpg', 'jpeg', 'png', 'webp'];
...
if (isset($_POST['add_item'])) {
    ...
    if ($category == 'Study Material' && $docFile == '' && !$docFileError) {
        $errors[] = "Please upload a PDF, DOCX, or image file for Study Material.";
    }
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="add-category">
            <div class="mb-3">
              ...
              <small class="text-muted d-block mt-2">Web App: add a link and an optional thumbnail image.<br>Study Material: upload a PDF, DOCX, or image.</small>
            </div>
          </div>
        </div>
